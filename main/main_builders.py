...
def make_splash(target, source, env):
    ...
    with methods.generated_wrapper(str(target[0])) as file:
        # Brand background for the boot splash. It matches the dark plate in the badge so the
        # transparent splash artwork blends into it instead of floating on gray.
        file.write(f"""\
#include "core/math/color.h"

static const Color boot_splash_bg_color = Color(0.094, 0.102, 0.137);
